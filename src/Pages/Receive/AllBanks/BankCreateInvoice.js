...
class BankCreateInvoice extends Component {
  constructor(props) {
    super(props);
    this.state = {
      show: false,
  ...
  render() {
    return (
      <Layout
        title="Receive Money"
        backto="/receive/AllBanks/BankSelected"
      >
        <Row>
          <Col>
            <div className="texttab-show">
              <div className="row bg-white position-relative">
                <div className="w-100 green-form px-3 pt-5">
                  ...
                  <div className="botal mb-2 px-3 d-flex justify-content-between align-items-center position-relative">
                    <Image
                      ...
                      className=""
                    />
                    <p className="m-0 position-absolute">Habib Metropolitan Bank</p>
                    <span className="pancal position-absolute">
                      <Link to="/">
                        <Image src="/assets/i/pancal.png" />
                      </Link>
                ...
                <div className="tick-box px-3 w-100 fixed-bottom">
                  <Link to="/receive/AllBanks/BankInvoiceCreated" className="w-100 tick-gray tick-green-text d-flex justify-content-center align-items-center">
                    Create Invoice
                  </Link>
                </div>
              </div>
...
export default withRouter(BankCreateInvoice);
